...
if not config.get_main_option("sqlalchemy.url"):
    config.set_main_option("sqlalchemy.url", get_settings().alembic_db_url)
...
# this is needed for PostGIS extension of PostgreSQL
...
def render_item(type_, obj, autogen_context):
    ...
    if type_ == "type" and obj.__class__.__module__.startswith("sqlalchemy_file."):
